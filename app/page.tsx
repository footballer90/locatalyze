      ...
      {quadrants.map(q => (
        <div key={q.key} style={{ background: q.bg, border: `1.5px solid ${q.border}`, borderRadius: 14, padding: '14px 16px', transition: 'transform .2s, box-shadow .2s' }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
            <div style={{ width: 26, height: 26, borderRadius: 8, background: q.dot, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><div style={{ width: 8, height: 8, borderRadius: 2, background: 'rgba(255,255,255,0.85)' }} /></div>
