...
const OTHER_TYPES = [
  { icon: '🍽️', label: 'Restaurants', href: '/use-case/restaurants' },
      ...
      <div style={{ minHeight: '100vh', background: S.n50, fontFamily: S.font }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 32, flexWrap: 'wrap' }}>
              <div style={{ flex: 1, minWidth: 280 }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                  <Link href="/auth/signup" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: S.brand, color: '#fff', borderRadius: 10, padding: '12px 22px', fontSize: 14, fontWeight: 700, textDecoration: 'none', boxShadow: '0 4px 16px rgba(15,118,110,0.35)' }}>
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '56px 20px 80px' }}>
          ...
          <div style={{ marginBottom: 56 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(220px,1fr))', gap: 14 }}>
              {[
                ...
                { label: 'Weaknesses', icon: '⚠️', color: S.amber, bg: S.amberBg, bdr: S.amberBdr, items: ['High rent in premium locations squeezes margin', 'Dependency on single peak window (7–9am)', 'Seasonal variation in outdoor areas', 'Limited parking in dense urban locations'] },
          ...
          <div style={{ background: S.n900, borderRadius: 20, padding: '40px', marginBottom: 48 }}>
            ...
            <Link href="/auth/signup" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: S.brand, color: '#fff', borderRadius: 10, padding: '13px 26px', fontSize: 14, fontWeight: 800, textDecoration: 'none', boxShadow: '0 4px 16px rgba(15,118,110,0.3)' }}>
