   ...
   <div style={{ minHeight: '100vh', background: S.n50, fontFamily: S.font }}>
    <div style={{ background: S.headerBg, position: 'relative', overflow: 'hidden' }}>
     ...
     <div style={{ borderRadius: 20, overflow: 'hidden', marginBottom: 56, position: 'relative' }}>
      ...
      <p style={{ fontSize: 15, color: '#9CA3AF', lineHeight: 1.8, marginBottom: 24, maxWidth: 560 }}>Paste any Australian address. Get delivery zone household mapping, cuisine saturation analysis, office density scoring and a full financial model in about 90 seconds.</p>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(200px,1fr))', gap: 12, marginBottom: 28 }}>
       {[['', 'Household density mapping in 3km delivery zone'], ['', 'Office worker density within 500m'], ['', 'Cuisine saturation analysis in delivery zone'], ['', 'Revenue model for walk-in plus delivery combined'], ['', 'GO / CAUTION / NO verdict in about 90 seconds']].map(([icon, text]) => (
