          ...
          <div style={{ maxWidth: 1000, margin: '0 auto', padding: '60px 24px 56px', position: 'relative' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 32, flexWrap: 'wrap' }}>
              <div style={{ flex: 1, minWidth: 280 }}>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(15,118,110,0.18)', border: '1px solid rgba(15,118,110,0.35)', borderRadius: 20, padding: '5px 14px', fontSize: 11, fontWeight: 700, color: S.brandLight, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: 16 }}>🍽️ Use Case Guide</div>
          ...
          <div style={{ marginBottom: 56 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(220px,1fr))', gap: 14 }}>
              {[
                ...
                { label: 'Weaknesses', icon: '⚠️', c: S.amber, bg: S.amberBg, bdr: S.amberBdr, items: ['Mon–Wed dinner trade often cashflow-negative in first year', 'High labour (35–40%) plus rent above 12% is unsustainable', 'Long lease commitment before concept has been market-tested', 'Seasonal volatility in tourist-dependent precincts'] },
