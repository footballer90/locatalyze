...
const TYPES = [
  ...
  { icon: '🍽️', label: 'Restaurants', href: '/use-case/restaurants', color: '#1D4ED8', bg: '#EFF6FF', desc: 'Evening trade, parking access and dining precinct analysis for restaurant operators.' },
        ...
        <div style={{ background: S.headerBg, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1000, margin: '0 auto', padding: '60px 24px 64px', position: 'relative', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/auth/signup" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: S.brand, color: '#fff', borderRadius: 10, padding: '14px 28px', fontSize: 15, fontWeight: 700, textDecoration: 'none', boxShadow: '0 4px 20px rgba(15,118,110,0.4)' }}>
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '64px 20px 80px' }}>
          ...
          <div style={{ background: S.n900, borderRadius: 24, padding: '48px', marginBottom: 72 }}>
            ...
            <div style={{ textAlign: 'center', marginTop: 32 }}>
              <Link href="/auth/signup" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: S.brand, color: '#fff', borderRadius: 10, padding: '14px 28px', fontSize: 15, fontWeight: 700, textDecoration: 'none', boxShadow: '0 4px 16px rgba(15,118,110,0.3)' }}>
          ...
          <div style={{ background: S.brandFaded, border: `1px solid ${S.brandBorder}`, borderRadius: 16, padding: '32px', marginBottom: 72 }}>
            ...
            {poll && (
              <div style={{ marginTop: 16, background: S.white, border: `1px solid ${S.brandBorder}`, borderRadius: 10, padding: '14px 18px' }}>
                <p style={{ fontSize: 14, color: S.brand, fontWeight: 700 }}>Locatalyze is built to solve exactly that. <Link href="/auth/signup" style={{ textDecoration: 'underline', color: S.brand }}>Run a free analysis →</Link></p>
              </div>
            )}
          </div>
          ...
          <div style={{ background: `linear-gradient(135deg,${S.headerBg},#0F2E2A)`, borderRadius: 24, padding: '56px 40px', textAlign: 'center', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <Link href="/auth/signup" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: S.brand, color: '#fff', borderRadius: 12, padding: '16px 32px', fontSize: 16, fontWeight: 800, textDecoration: 'none', boxShadow: '0 6px 24px rgba(15,118,110,0.4)' }}>
