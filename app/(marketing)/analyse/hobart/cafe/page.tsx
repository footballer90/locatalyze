    ...
    <div style={{ minHeight: '100vh', background: S.n50, fontFamily: "'DM Sans','Helvetica Neue',Arial,sans-serif", color: S.n900 }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '52px 24px 80px' }}>
        ...
        <section id="suburbs" style={{ marginBottom: 44 }}>
          ...
          <DataNote text="Scores: Locatalyze Scoring v2.1 — Rent Affordability 20%, Competition 25%, Market Demand 20%, Profitability 25%, Location Quality 10%. Aggregated from ABS, REIWA, Tourism Tasmania, Geoapify data. April 2026."/>
        </section>
