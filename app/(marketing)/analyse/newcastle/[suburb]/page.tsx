...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://locatalyze.com/analyse/newcastle/${data.slug}`,
    },
    openGraph: {
      title: data.metaTitle,
      description: data.metaDescription,
      url: `https://locatalyze.com/analyse/newcastle/${data.slug}`,
      type: 'article',
    },
  }
}
...
function SuburbSchema({ suburb }: { suburb: NewcastleSuburb }) {
  const schema = {
    ...
    url: `https://locatalyze.com/analyse/newcastle/${suburb.slug}`,
    about: {
      '@type': 'Place',
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Newcastle Business Guide', item: 'https://locatalyze.com/analyse/newcastle' },
      { '@type': 'ListItem', position: 3, name: suburb.name, item: `https://locatalyze.com/analyse/newcastle/${suburb.slug}` },
    ],
  }
