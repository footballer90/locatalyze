    ...
    <div style={{ minHeight: '100vh', background: S.n50, fontFamily: "'DM Sans','Helvetica Neue',Arial,sans-serif", color: S.n900 }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '52px 24px 80px' }}>
        ...
        <section id="suburbs" style={{ marginBottom: 44 }}>
          ...
          <DataNote text="Scores: Locatalyze Scoring v2.1 — Rent Affordability 20%, Competition 25%, Market Demand 20%, Profitability 25%, Location Quality 10%. Aggregated from ABS 2024–26, NSW commercial data, Geoapify. April 2026." />
        </section>
        ...
        <section style={{ marginBottom: 44 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 14 }}>
            {[
              { title: 'Morning foot traffic', weight: 'Critical demand window', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /></svg>, detail: 'Bakeries live on the 5:30–8:30am window. A location with 400+ pedestrians during peak morning hour validates demand. Visit your shortlisted site on a Wednesday at 6:15am and count foot traffic for 30 minutes. That number multiplied by a conservative 12–15% capture rate gives daily commuter potential.' },
              { title: 'Household income', weight: 'Catchment spending power', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" /></svg>, detail: 'Newcastle\'s average artisan bakery ticket is $6.50. Below $70,000 median income, customers revert to supermarket bread under pressure. Above $90,000 — particularly in mining-legacy suburbs — artisan pricing is habitual rather than discretionary. Merewether\'s $96,000 median means residents willingly pay for quality sourdough.' },
              { title: 'Competition within 500m', weight: 'Market saturation check', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" /></svg>, detail: '0–1 direct competitor validates pre-saturation entry. 2–3 competitors is manageable with differentiation. Four or more (including supermarket bakery options) reduces new-entrant capture potential materially. Merewether\'s zero dedicated artisan competitors is ideal. Darby Street\'s three validates demand but requires clear positioning.' },
              { title: 'Rent-to-revenue ratio', weight: 'Margin gate', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" /><line x1="1" y1="10" x2="23" y2="10" /></svg>, detail: 'For bakeries — more stringent than cafés. Monthly rent ÷ projected monthly revenue must be under 10%. At $3,500/month rent, you need $35,000/month revenue (approximately 145 customers/day at $6.50 average). If a location cannot plausibly deliver this, the rent is too high.' },
              { title: 'Surf/beach culture timing', weight: 'Local trade pattern', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9l-7 7m0-7l7 7M6 3h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5a2 2 0 012-2z" /></svg>, detail: 'Merewether surfers arrive 5:45–6:30am (before work). Families arrive 7:30–8:15am. This creates two distinct morning peaks instead of Darby Street\'s single commute wave. Dual-peak timing compounds revenue opportunity and buffers against single traffic engine failure.' },
            ].map(f => (
