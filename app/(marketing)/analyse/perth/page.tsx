 ...
 return (
   ...
   <div style={{ background: 'linear-gradient(135deg, #022C22 0%, #064E3B 40%, #0F766E 80%, #0891B2 100%)', padding: '60px 24px 52px' }}>
    ...
    <div style={{ background: '#F8FAFC', border: `1px solid ${S.border}`, borderRadius: 10, padding: '12px 16px', marginBottom: 40, display: 'flex', gap: 10 }}>
     ...
     <div><p style={{ fontSize: 15, fontWeight: 700, color: '#065F46', marginBottom: 4 }}>Have a specific Perth address in mind?</p><p style={{ fontSize: 13, color: '#047857' }}>Get a full GO/CAUTION/NO verdict with competitor map and financial model in 60 seconds. Free.</p></div>
