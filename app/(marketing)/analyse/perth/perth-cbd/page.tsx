...
const nearby = [
  ...
  { name: 'Mount Lawley', slug: 'mount-lawley', score: 85, verdict: 'GO' as const },
]

const scoreChartData = [
  { category: 'Foot Traffic', score: 82 },
  { category: 'Demographics', score: 80 },
  { category: 'Rent Viability', score: 58 },
  { category: 'Competition Gap', score: 62 },
]
