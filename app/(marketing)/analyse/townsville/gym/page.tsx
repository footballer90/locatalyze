    ...
    <div style={{ minHeight: '100vh', background: S.n50, fontFamily: "'DM Sans','Helvetica Neue',Arial,sans-serif", color: S.n900 }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '52px 24px 80px' }}>
        ...
        <section id="suburbs" style={{ marginBottom: 44 }}>
          ...
          <DataNote text="Scores: Locatalyze Scoring v2.1 — Rent Affordability 20%, Competition 25%, Market Demand 20%, Profitability 25%, Location Quality 10%. Defence/FIFO context informs inputs; weights are the public v2.1 model. Lavarack catchment mapping, commercial listings Q4 2025, operator interviews. April 2026." />
        </section>
        ...
        <section style={{ marginBottom: 44 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 14 }}>
            {[
              { title: 'Military/FIFO proximity', weight: 'Primary catchment driver', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87" /><path d="M16 3.13a4 4 0 010 7.75" /></svg>, detail: 'Lavarack Barracks creates a 10,000+ person demographic block with structured training habits and zero price sensitivity. Map Defence Housing Australia accommodation clusters. Proximity within 5km to base or officer housing multiplies gym viability by 1.8–2.2×. FIFO roster alignment (verify 2-week-on/2-week-off patterns with mining coordinators) ensures recurring off-rotation membership.' },
              { title: 'Wet season demand', weight: 'Seasonal utilisation', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.59 0.885L4.21 2.773a1.993 1.993 0 00-1.194 2.481l1.933 8.896a6 6 0 00 5.821 4.432h6.238a6 6 0 005.822-4.432l1.933-8.896a1.993 1.993 0 00-1.194-2.481l-5.38-1.888a6 6 0 00-5.494 0z" /></svg>, detail: 'November–April wet season makes outdoor training brutal (35°C+ humidity). Indoor gym demand rises 20–30% structurally during these months. A gym in Townsville sees utilization peaks that temperate cities never achieve. This seasonal demand buffer absorbs membership growth delays and survival through slower months.' },
              { title: 'Rent-to-membership ratio', weight: 'Unit economics', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" /><line x1="1" y1="10" x2="23" y2="10" /></svg>, detail: 'Monthly rent ÷ (members × $55/week × 4.3 weeks). Townsville achieves 23–28% at break-even; most other cities need 18–20%. The military demographic\'s price insensitivity and low churn (8–12% above standard) justify higher rent-to-member ratios. At $2,800/month rent, 280 members = $60,640 revenue. Profitable.' },
              { title: 'Commercial availability', weight: 'Tenancy & setup reality', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={S.brand} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" /><line x1="9" y1="9" x2="15" y2="9" /><line x1="9" y1="15" x2="15" y2="15" /></svg>, detail: 'Townsville commercial real estate is undersupplied with purpose-built fitness tenancies. Most available stock is 1,500–2,500sqm shell spaces in Aitkenvale and Kirwan. Construction costs are low (30–40% below Brisbane). Lease entry timelines are 8–12 weeks. Landlords are motivated — commercial vacancy is 12–14%, driving rents toward operators\' favor.' },
            ].map(f => (
