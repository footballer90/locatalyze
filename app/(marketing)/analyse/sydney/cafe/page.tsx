   ...
   {/* Nav */}
    ...
    {/* Data disclaimer */}
     ...
     <div>
      ...
      <p style={{ fontSize: 13, color: '#047857' }}>Get a full GO/CAUTION/NO verdict with competitor map and financial model in ~90 seconds. Free.</p>
     </div>
     ...
     <p style={{ fontSize: 15, color: 'rgba(199,210,254,0.65)', maxWidth: 480, margin: '0 auto 26px', lineHeight: 1.75 }}>
      ...
      Analyse my Sydney address free →
          ...
          <p style={{ fontSize: 12, color: 'rgba(199,210,254,0.35)', marginTop: 10 }}>No credit card · 1 free preview · ~90 seconds</p>
    </div>
