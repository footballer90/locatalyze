...
const NEARBY: NearbySuburb[] = [
  ...
  { name: 'Surry Hills', slug: 'surry-hills', score: sScore('Surry Hills'), verdict: sVerdict('Surry Hills') },
  { name: 'Sydney CBD', slug: 'sydney-cbd', score: sScore('Sydney CBD'), verdict: sVerdict('Sydney CBD') },
]
