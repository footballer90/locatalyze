    ...
    <div style={{ background: S.n50, minHeight: '100vh' }}>
      ...
      <div style={{ background: `linear-gradient(135deg, #0F766E 0%, #0B5E57 100%)`, padding: '60px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 48, fontWeight: 900, color: '#FFFFFF', marginBottom: 24 }}>Hornsby</h1>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ background: S.white, border: `1px solid ${S.border}`, borderRadius: 16, padding: '32px', marginBottom: 48 }}>
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Allied Health (Physio, Dental, Psychology, Women's Health)</h3>
              <VerdictBadge v="GO" />
            </div>
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Specialty Grocery/Deli</h3>
              <VerdictBadge v="GO" />
            </div>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Family-Format Café with Brunch Emphasis</h3>
              <VerdictBadge v="GO" />
            </div>
        ...
        <div style={{ background: S.white, border: `1px solid ${S.border}`, borderRadius: 16, padding: '32px', marginBottom: 48 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Trendy Concept Bars or Late-Night Hospitality</h3>
              <VerdictBadge v="NO" />
            </div>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>High-Fashion Boutique Retail</h3>
              <VerdictBadge v="NO" />
            </div>
        ...
        <div style={{ background: S.white, border: `1px solid ${S.border}`, borderRadius: 16, padding: '32px', marginBottom: 48 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, marginBottom: 6 }}>Westfield Dependency</h3>
          ...
          <div style={{ marginBottom: 16 }}>
            <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, marginBottom: 6 }}>Sunday Trading is Thin</h3>
          ...
          <div>
            <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, marginBottom: 6 }}>Rent Growth Trajectory</h3>
