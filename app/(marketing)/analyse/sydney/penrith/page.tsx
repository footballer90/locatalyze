      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ background: S.white, border: `1px solid ${S.border}`, borderRadius: 16, padding: '32px', marginBottom: 48 }}>
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Specialty Café</h3>
              <VerdictBadge v="GO" />
            </div>
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Sports-Adjacent Hospitality (Craft Beer, Quality Pub Dining)</h3>
              <VerdictBadge v="GO" />
            </div>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Health and Allied Health (Physio, Women's Health, Sports Medicine)</h3>
              <VerdictBadge v="GO" />
            </div>
        ...
        <div style={{ background: S.white, border: `1px solid ${S.border}`, borderRadius: 16, padding: '32px', marginBottom: 48 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Fine Dining (Over $90pp Degustation Format)</h3>
              <VerdictBadge v="NO" />
            </div>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, margin: 0 }}>Fashion Boutiques (Over $200 ATV)</h3>
              <VerdictBadge v="NO" />
            </div>
        ...
        <div style={{ background: S.white, border: `1px solid ${S.border}`, borderRadius: 16, padding: '32px', marginBottom: 48 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, marginBottom: 6 }}>Aerotropolis Timeline Risk</h3>
          ...
          <div style={{ marginBottom: 16 }}>
            <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, marginBottom: 6 }}>Westfield Penrith Gravitational Pull</h3>
          ...
          <div>
            <h3 style={{ color: '#1C1917', fontSize: 16, fontWeight: 700, marginBottom: 6 }}>Over-Reliance on Panthers Events</h3>
