     ...
     {TOP_SUBURBS.map((sub, idx) => (
       ...
       <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 20, alignItems: 'start' }}>
        <div>
         ...
         <DataNote text="Income: ABS 2023–24. Rent: CBRE Q4 2025. Profit: Locatalyze model, $250,000 setup, IBISWorld restaurant COGS benchmarks. Daily rev. target = the daily revenue consistent with the full modelled scenario — not the zero-profit survival point, which is significantly lower. A restaurant covers its fixed costs (rent + overhead) at roughly 30–35% of this figure; the daily revenue target represents the level needed to achieve the modelled profit."/>
