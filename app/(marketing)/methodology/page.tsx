...
export const metadata: Metadata = {
  title: 'How Locatalyze Works — Data Sources & Methodology',
  description: 'Learn how Locatalyze analyses business locations. Our data sources, scoring methodology, financial modelling approach and accuracy disclaimer.',
}
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        <section style={{ marginBottom: 64 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 }}>
            <DataCard icon="🗺️" title="Google Maps Platform" badge="Live API" desc="Real-time competitor locations, business types, ratings, review counts and operating hours within your analysis radius." />
            ...
            <DataCard icon="🤖" title="AI Analysis Engine" badge="Proprietary AI" desc="Our AI synthesises all inputs to produce the narrative analysis, risk scenarios, SWOT assessment and 3-year projection model." />
        ...
        <section style={{ marginBottom: 64 }}>
          <div style={{ background: S.amberBg, border: `1px solid ${S.amberBdr}`, borderRadius: 16, padding: '24px 28px' }}>
            <p style={{ fontSize: 14, fontWeight: 800, color: S.amber, marginBottom: 12 }}>⚠️ Important: Use as a decision-support tool</p>
