   ...
   {/* Nav */}
    ...
    {/* ── How it works ── */}
      ...
      {[
       ...
       { label: 'Break-even Customers / Day', formula: 'Fixed costs ÷ (avg_ticket × (gross_margin% − other_variable_costs%) × 26)', note: 'The minimum daily customers needed to cover rent and staffing over the 26 service days per month (matching the revenue formula). Compared against your projected daily demand. If projected > break-even, the location is viable at current inputs. The zero-profit survival floor (rent + overheads only, excluding staff cost) is lower than this number.' },
