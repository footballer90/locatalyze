...
const DATA: Record<Verdict, ReportData> = {
  ...
  go: {
    ...
    score: 82,
    metrics: [
      { l: 'Monthly Revenue',  v: '$91,200',  d: '+12% vs benchmark', c: D.e },
      { l: 'Monthly Profit',   v: '$24,800',  d: '27% margin',        c: D.e },
      { l: 'Payback Period',   v: '7 months', d: 'Below avg 14mo',    c: D.e },
      { l: 'Competitors 800m', v: '4',        d: 'Low density',       c: D.e },
    ],
    ai: 'Strong opportunity. High-demand demographics combined with manageable competition makes this an excellent location for a specialty coffee concept. Profitability projected within 7 months — well below the 14-month category average.',
    pentagon: [
    ...
    finCards: [
      { l: 'Monthly Revenue', v: '$91,200',  s: 'Projected year 1'  },
      { l: 'Monthly Profit',  v: '$24,800',  s: 'After all costs'   },
      { l: 'Annual Profit',   v: '$297,600', s: 'Year 1 projection' },
    ...
    finRows: [
      ...
      { l: 'Gross Revenue',   v: '$91,200', div: true },
  ...
  warn: {
    ...
    metrics: [
      ...
      { l: 'Payback Period',   v: '18 months', d: 'Above avg 14mo',   c: D.red   },
    ...
    finCards: [
      ...
      { l: 'Annual Profit',   v: '$110,400', s: 'Year 1 projection' },
  ...
  no: {
    ...
    metrics: [
      ...
      { l: 'Payback Period',   v: '32+ months', d: '2x avg 14mo',       c: D.red },
