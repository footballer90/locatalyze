 ...
 if (isPro) return <>{children}</>
  ...
  return (
   ...
   <div className="absolute inset-0 bg-white/70 backdrop-blur-sm rounded-xl flex flex-col items-center justify-center">
    ...
    <div className="text-sm font-medium text-slate-900 mb-1">Premium feature</div>
    <div className="text-xs text-slate-500 text-center mb-4 max-w-[200px]">
     {featureName} requires an unlocked report
        </div>
        <a
          href="/upgrade"
          className="bg-slate-900 text-white text-xs px-4 py-2 rounded-md hover:bg-slate-700 transition-colors no-underline"
    >
