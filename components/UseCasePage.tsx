...
const CONFIGS: Record<string, Config> = {
  ...
  restaurants: {
    icon: '', title: 'Restaurants', subtitle: 'Location analysis for restaurant owners',
  ...
  keyFactors: [
   ...
   { icon: '', title: 'Parking & accessibility', desc: 'Dinner diners often drive. Easy parking within 200m significantly affects covers. Public transport access matters for lunch trade.' },
   { icon: '', title: 'Restaurant competition', desc: 'A dining precinct with complementary restaurants can be a strength — diners visit areas, not just individual restaurants. But direct category overlap within 100m is a risk.' },
  ...
  keyFactors: [
   ...
   { icon: '', title: 'Parking & size', desc: 'A gym needs a minimum 250–400 sqm for a viable offering. Ground floor or easy upper floor with lift access. Parking for members who drive during peak hours.' },
  ...
  keyFactors: [
   ...
   { icon: '', title: 'Speed of service access', desc: 'Easy access for delivery riders matters. A location on a main road with no parking is frustrating for riders. Side streets with easy pull-in are better.' },
   ...
   <div style={{ minHeight: '100vh', background: S.n50, fontFamily: S.font }}>
    <div style={{ background: S.headerBg, padding: '60px 24px 48px', textAlign: 'center' }}>
     ...
     <div style={{ marginBottom: 48 }}>
       ...
       {config.keyFactors.map((f, i) => (
                <div key={i} style={{ background: S.white, border: `1px solid ${S.n200}`, borderRadius: 14, padding: '20px' }}>
